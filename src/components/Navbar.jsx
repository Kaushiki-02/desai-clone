...
const Dropdown = ({ title, items }) => {
  ...
  return (
    ...
    >
      <button className="flex items-center px-3 py-2 font-semibold text-black hover:text-pink-600 text-xs">
        {title}
        <FaChevronDown className="ml-1 text-xs" />
      </button>
      {open && (
        <div className="absolute left-0 mt-2 w-48 bg-white border border-gray-200 z-50">
  ...
  return (
    <>
      ...
      <div className="bg-white border-b border-gray-200">
        <div className="max-w-7xl mx-auto px-4 py-3 flex flex-wrap items-center justify-center space-x-8 text-xs">
          {/* Logo */}
          <a href="/">
